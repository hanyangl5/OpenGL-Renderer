...
public:
	...
	~Deferrdpass();
	void Draw(std::shared_ptr<Framebuffer>& dst,std::unordered_map < std::string, std::shared_ptr<Model>> scene, std::shared_ptr<Camera> cam, std::shared_ptr<Skybox>skybox = nullptr);
